...
import { IconContainer, UserImage, UserText } from 'styles/layouts/Avatar'
        ...
        {withOptions && !selectedImage && (
          <>
            <input
              ...
              name='avatar'
              accept='image/*'
              onChange={handleAvatarCropper}
            />
            <IconContainer>
              {!selectedImage ? <MdAddAPhoto /> : <MdNoPhotography />}
            </IconContainer>
          </>
        )}
      </UserImage>
